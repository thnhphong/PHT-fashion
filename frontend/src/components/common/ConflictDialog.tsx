...
export default function ConflictDialog({ isOpen, onClose, onKeep, onDiscard }: ConflictDialogProps) {
  return (
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-orange-100 sm:mx-0 sm:size-10">
                      <ShoppingBag className="size-6 text-orange-600" aria-hidden="true" />
                    </div>
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          You have items in your guest cart and items in your account's cart. What would you like to do?
                        </p>
                      </div>
                    </div>
                  </div>
