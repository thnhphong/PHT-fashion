...
const ProductDetail = () => {
  ...
  const { openChatFromProduct, reconnectSocket } = useChat();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full py-2 border border-gray-300 text-gray-700 rounded-full font-medium hover:bg-gray-50 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
